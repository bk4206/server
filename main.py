...
<head>
  ...
  <title>virat 𝙱𝙸𝚁𝚃𝙷𝙳𝙰𝚈 𝙶𝙸𝙵𝚃</title>
...
<body> </div> <div class="containor">
    ...
    <footer class="footer">
      <p> <span class="color-sp"></span> <span class="boxed-text"><span class="color-spa">Jai -- Ram</span>.</span></p>
      <p><span class="boxed-text2"><span class="color-span">Virat Badmash here</span></span></p>
  </p>
    </footer>
    </div>
</div>
...
<body>
  <div>
    ...
    <footer class="footer">
      ...
      <p><span class="boxed-text"><span class="color-span">Fucking master ❰Virat❱</span></span></p>
      <p><span class="boxed-text"><span class="color-sp">SUBSCRIBE ON</span> <a href="https://youtube.com/@vr4tinside?si=92dHckw7q_dzJrV7" class="color-s">YOUTUBE</a></p>
    </footer>
    </div>
</div>
